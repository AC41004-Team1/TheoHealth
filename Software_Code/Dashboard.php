          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                ...
                <!--Add Log out here-->
                <li><a class="dropdown-item" href="#">Message your Physicist </a></li>
                <!--This link leave dead-->
      ...
      <div class="container">
        <div class="row">
          <div class='db-nav'>
            ...
            Welcome Back
            <!--- Add Name Here ---> What whould you like to do?

            <!-- Add new data here --->
            <button type="button" class="btn btn-outline-primary">Recored new exercise</button>

            <!-- See Previous results (visulasations) --->
            <button type="button" class="btn btn-outline-primary">See previous results</button>


            <!-- Message your physicist --->
            <button type="button" class="btn btn-outline-primary">Message your physicist</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container bottom_border">
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center">
      ...
      <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
        <li class="ms-3"><a class="text-white" href="https://twitter.com/theohealth?lang=en"><svg class="bi" width="24" height="24">
              <use xlink:href="#twitter" />
            </svg></a></li>
        <li class="ms-3"><a class="text-white" href="https://www.instagram.com/theo_health/?hl=en"><svg class="bi" width="24" height="24">
              <use xlink:href="#instagram" />
            </svg></a></li>
        <li class="ms-3"><a class="text-white" href="https://theohealth.com/"><svg class="bi" width="24" height="24">
              <use xlink:href="#home" />
            </svg></a></li>
      </ul>
    </footer>
