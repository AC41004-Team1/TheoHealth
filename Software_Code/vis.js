...
class BodyVis {
            ...
            Object.keys(this.sensorAreas).forEach((e) => {
                ...
                if (intersectName == this.sensorAreas[e].obj.name) {
                    this.sensorAreas[e].colReset = true
                        //this.sensorAreas[e].mat = this.sensorAreas[e].obj.material.color
    ...
    load() {
        ...
        gltfLoader.load('./person2.gltf', (gltf) => {
            this.gltf = gltf
...
document.getElementById('canvas-container').style = `background-color: ${test.colours.teal}`